...
function PitchBoard({ team }: { team: Team }) {
...
function App() {
  ...
  return (
    <MantineProvider theme={theme} defaultColorScheme="dark">
      ...
      <Modal opened={!!selectedTeam} onClose={() => setSelectedTeam(null)} title={selectedTeam ? `${selectedTeam.name} roster` : ''} size="xl">
        {selectedTeam && (
          <Stack>
            <Group>
