import { ActionIcon, AppShell, Box, Button, Group, Text, ThemeIcon, Title, Tooltip } from '@mantine/core';
import { IconMusic, IconShare3, IconTrash, IconTrophy } from '@tabler/icons-react';
      ...
      <Group h="100%" px="md" justify="space-between">
        ...
        <Group gap="xs">
          <Tooltip label="Share prediction">
            <ActionIcon variant="light" size="lg" onClick={onShare}><IconShare3 size={18} /></ActionIcon>
          </Tooltip>
          <Tooltip label="Clear all predictions">
            <ActionIcon variant="light" color="red" size="lg" onClick={onClear}><IconTrash size={18} /></ActionIcon>
          </Tooltip>
