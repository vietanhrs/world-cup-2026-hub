...
export const groupMatches: ScheduleMatch[] = [
  {
    ...
    result: { home: 2, away: 0, status: 'FT' },
  },
  {
    id: 'g-A-2',
    stage: 'group',
  ...
  },
  {
    ...
    homeRef: 'canada',
    awayRef: 'bosnia',
    result: { home: 1, away: 1, status: 'FT' },
  },
  {
    id: 'g-D-1',
    stage: 'group',
    ...
    homeRef: 'usa',
    awayRef: 'paraguay',
    result: { home: 4, away: 1, status: 'FT' },
  },
  {
    id: 'g-C-1',
    stage: 'group',
    ...
    homeRef: 'haiti',
    awayRef: 'scotland',
    result: { home: 0, away: 1, status: 'FT' },
  },
  {
    id: 'g-D-2',
    stage: 'group',
  ...
  },
  {
    ...
    homeRef: 'germany',
    awayRef: 'curacao',
    result: { home: 7, away: 1, status: 'FT' },
  },
  {
    id: 'g-F-1',
    stage: 'group',
  ...
  },
  {
    ...
    homeRef: 'sweden',
    awayRef: 'tunisia',
    result: { home: 5, away: 1, status: 'FT' },
  },
  {
    id: 'g-H-1',
    stage: 'group',
  ...
  },
  {
    ...
    homeRef: 'spain',
    awayRef: 'cabo-verde',
    result: { home: 0, away: 0, status: 'FT' },
  },
  {
    id: 'g-G-1',
    stage: 'group',
  ...
  },
  {
    ...
    homeRef: 'argentina',
    awayRef: 'algeria',
    result: { home: 3, away: 0, status: 'FT', eventId: '760433' },
  },
  {
    id: 'g-J-2',
    stage: 'group',
    ...
    homeRef: 'austria',
    awayRef: 'jordan',
    result: { home: 3, away: 1, status: 'FT', eventId: '760431' },
  },
  {
    id: 'g-L-1',
    stage: 'group',
    ...
    homeRef: 'ghana',
    awayRef: 'panama',
    result: { home: 1, away: 0, status: 'FT', eventId: '760434' },
  },
  {
    id: 'g-L-2',
    stage: 'group',
    ...
    homeRef: 'england',
    awayRef: 'croatia',
    result: { home: 4, away: 2, status: 'FT', eventId: '760437' },
  },
  {
    id: 'g-K-1',
    stage: 'group',
    ...
    homeRef: 'portugal',
    awayRef: 'congo-dr',
    result: { home: 1, away: 1, status: 'FT', eventId: '760435' },
  },
  {
    id: 'g-K-2',
    stage: 'group',
    ...
    homeRef: 'uzbekistan',
    awayRef: 'colombia',
    result: { home: 1, away: 3, status: 'FT', eventId: '760436' },
  },
  {
    id: 'g-A-3',
    stage: 'group',
